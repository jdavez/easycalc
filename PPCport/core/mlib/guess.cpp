/*
 *   $Id: guess.cpp,v 1.2 2009/10/17 13:48:34 mapibid Exp $
 *
...
guess(Trpn item)
{
    ...
    if (item.type == real) {
        result = (TCHAR *) MemPtrNew((MAX_FP_NUMBER+1)*sizeof(TCHAR));
        ...
        result = (TCHAR *) MemPtrNew((MAX_FP_NUMBER*3)*sizeof(TCHAR));

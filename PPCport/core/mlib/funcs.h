/*
 *   $Id: funcs.h,v 1.6 2009/12/15 21:37:44 mapibid Exp $
 *
...
CError text_function(TCHAR *name,Int16 paramcount,CodeStack *stack) PARSER;
void set_func_argument(Trpn *arg,UInt16 argcount) PARSER;
void decr_func_argument(void) PARSER;
Boolean varfunc_name_ok(TCHAR *name,rpntype type) PARSER;
...
Boolean is_constant(TCHAR *name) PARSER;
